        ...
        child: Column(
          ...
          children: [
            ...
            _buildSection(
              ...
              'How to use the main interface',
              [
                '**Deck Management:**',
                '• Click on any deck title to edit it (blue, underlined)',
                ...
                '',
                '**Categories:**',
                '• Use dropdown to filter decks by category',
                '• Default category contains built-in decks',
                '• Create custom categories to organize your decks',
              ],
            ),
            const SizedBox(height: 16),
            _buildSection(
            ...
            _buildSection(
              ...
              [
                '**Import Decks:**',
                '• Click "Import Deck" (green + button) on home screen',
                '• Upload a CSV file with deck data',
                '• CSV Format: First row contains headers, subsequent rows contain data',
                '• Example: "Question,Answer\\nWhat is 2+2?,4\\nCapital of France?,Paris"',
                '',
                '**Export Decks:**',
                '• Click "Export" on any deck (download icon)',
                ...
                '',
                '**Default Decks:**',
                '• Built-in decks include Chinese Radicals, Hiragana, and more',
                '• Click ↺ (Reset) button to reload default decks from assets',
                '• Useful if you updated asset files and want to see changes',
              ],
            ),
            const SizedBox(height: 16),
            _buildSection(
